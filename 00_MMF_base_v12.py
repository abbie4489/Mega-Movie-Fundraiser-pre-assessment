...
took ticket price out if the snack calculation
and added it back in as part of the subtotal (lines 320 -335)
...
if print_all == "Y":
    ...
    print(movie_frame[["Ticket", "Snack_Cost", "Sub Total", "Surcharge",
                       "Total"]])
print()
