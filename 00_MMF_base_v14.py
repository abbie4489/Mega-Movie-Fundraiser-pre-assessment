...
Move the ticket counting routine into its own function - so it can be called
each time a ticket is sold as well as at the end of the summary print.
...
figures using the currency feature 
"""
